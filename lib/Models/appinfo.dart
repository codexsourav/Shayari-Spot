...
Color iconcolor = dvtheme != 'dark'
    ...
    : const Color.fromARGB(255, 255, 255, 255);
Color whitecolor = dvtheme != 'dark'
    ? const Color.fromARGB(255, 255, 255, 255)
    : const Color.fromARGB(255, 255, 255, 255);
Color boxiconcolor = dvtheme != 'dark'
    ? const Color.fromARGB(129, 255, 255, 255)
    : const Color.fromARGB(146, 255, 255, 255);
Color inactivecolor = dvtheme != 'dark'
    ? const Color.fromARGB(80, 255, 255, 255)
    : const Color.fromARGB(88, 255, 255, 255);
Color drawercolor = dvtheme != 'dark'
    ? const Color.fromARGB(255, 54, 5, 104)
    : const Color.fromARGB(255, 22, 22, 22);
Color blackcolor = dvtheme != 'dark'
    ? const Color.fromARGB(255, 0, 0, 0)
    : const Color.fromARGB(255, 5, 5, 5);
Color alertblackcolor = dvtheme != 'dark'
    ? const Color.fromARGB(255, 22, 22, 22)
    : const Color.fromARGB(255, 54, 54, 54);
Color alertcolor = dvtheme != 'dark'
    ? const Color.fromARGB(255, 105, 66, 179)
    : const Color.fromARGB(255, 43, 43, 43);
Color tpiconcolor = dvtheme != 'dark'
...
const String privacypolicyurl =
    'https://shayarisspot.web.app/privacypolicy.html';
...
// app download link
const String applinkshareinfo =
    'Hi , I AM Useing A Cool Shayari App Of Intresting Shayari.  If You Interest Download Now - https://shayarisspot.web.app';
